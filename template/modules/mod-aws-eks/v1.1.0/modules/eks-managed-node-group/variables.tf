################################################################################
# Naming inputs (consumed by locals.tf via mod-naming-convention).
# Required — no defaults. Caller must pass them.
################################################################################

variable "company" {
  description = "Company short code, e.g. 'comp'."
  type        = string
}

variable "project" {
  description = "Project short code, e.g. 'proj'."
  type        = string
}

variable "environment" {
  description = "Target environment, e.g. 'nonprod', 'prod'."
  type        = string
}

variable "suffix" {
  description = "Optional suffix; include leading dash yourself if non-empty."
  type        = string
  default     = ""
}

################################################################################
# Upstream module inputs
################################################################################
